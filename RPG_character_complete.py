...
respuesta_bot = obtener_respuesta("actúa como un maestro diseñador de personajes de fantasia con maestría en estudios de escritura y generación de lore y backgrounds de personajes fantasicos. A continuación voy a darte la información general de un personaje. necesito que me devulevas la hoja de personaje organizada y extendida con atributos medibles con base en todas las características imputadas, pero también necesito que a partir de la información imputada le inventes un background épico muy extenso y detallado con nombres propios fantasticos inventados y asignados para personas, hechos y lugares y objetos y artefactos determinantes en la historia del personaje. Esto anterior es obligatorio. Si reconoces un lugar, ponle un nombre epico en un idioma ancestral inventado para geografía fantastica. si hay un elemento o artefacto definitorio para el personaje dale nombre en ese mismo idioma inventado. Dentro de las tareas DEBES Inventarle una raza al personaje, un color de piel aleatorio, la descripcion aleatoria del perfil fisico y de la cara con rasgos unicos en el contexto del personaje. estos datos deben ser descritos minuciosamente.Todo debe estar basado en razas de juegos de rol ya creados, y genera finalmente una hoja de personaje con un background unico con nombres unicos al personaje con base en su raza en relacion con el personaje y sus aptitudes y desarrollo. tambien inventa y describe caratcerísticas unicas del personaje, asi como habilidades natas con base en sus atributos, fortalezas, fobias, etica y moral, alineacion moral, traumas, personalidad y propósito en la vida, con nombres propios de personajes,lugares y crituras relevantes. Debes añadir ese background a la hoja de personaje como si fuese su pasado personalizado muy extenso y detallado. recuerda que es un juego de rol de fantasía así que puedes inventar cuanto quieras, basado en multiples juegos de rol y eso incluye nombres, lugares, fechas, epocas, tecnologia, magia y lore propio del personaje. Extiende la historia del personaje lo que más puedas con todos los detalles personalizados posibles que puedas añadir. devuélveme una hoja de personaje lo más completa y jugable posible con todas las características solicitadas legibles y con numeros que puedan ser mesurables para cada habilidad, fobia y trauma en una escala apropiada y estandard para todos los stats. tambien debe sinventar una serie de hechizos relacionados a la clase del personaje, teniendo en cuenta que si el personaje esta relacionado con la magia debe tener mas hechizos y si no, debe tener menos relacionados con su propio lore y atributos y características unicas. haz el texto lo mas extenso y detallado posible. todo lo anterior es obligatori asi que devuelve una salida acorde a todas las ordenes anteriores y a la informacion a continuación: \n\n" + contenido_filtrado, chat)
